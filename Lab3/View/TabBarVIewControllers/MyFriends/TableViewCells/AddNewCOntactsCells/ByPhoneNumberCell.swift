...
typealias ByPhoneNumberCellConfigurator = TableCellConfigurator<ByPhoneNumberCell, Cell>

class ByPhoneNumberCell: UITableViewCell, ConfigurableCell {
