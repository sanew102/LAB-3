//
//  FromContactsTableViewCell.swift
//  Lab3
//
...
typealias FromContactsTableViewCellConfigurator = TableCellConfigurator<FromContactsTableViewCell, Cell>

class FromContactsTableViewCell: UITableViewCell, ConfigurableCell {
